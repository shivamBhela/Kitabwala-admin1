/**
 * types/analytics.ts
 * Response shape for the real Same-Day Analytics endpoint (kitabwalah-api
 * GET /analytics/same-day). Mirrors the backend's SameDayAnalyticsResponseDto.
 */

export interface SameDayAnalytics {
  date: string;
  ordersCount: number;
  revenue: number;
